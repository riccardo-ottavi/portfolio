                ...
                <div className="marquee-track">
                    {[0, 1].map((i) => (
                        <div key={i} className="marquee-group">
                            <span>Pensa</span><span className="accent">✦</span>
                            <span>Struttura</span><span className="accent">✦</span>
                            <span>Scrivi</span><span className="accent">✦</span>
                            <span>Diagnostica</span><span className="accent">✦</span>
                            <span>Cancella</span><span className="accent">✦</span>
                        </div>
                    ))}
                </div>
            </div>
                    ...
                    <div>
                        <Reveal delay={100}>
                            <p className="about-text">
                                Dopo un percorso di studi di stampo
                                ibrido umanistico e scientifico, ho sviluppato una
                                forte passione per la programmazione.
                            </p>
                        </Reveal>
                        <Reveal delay={250}>
                            <div className="stats">
